...
// ===== FIXED: Active link management =====
document.addEventListener('DOMContentLoaded', () => {
    isNavigating = false;
    
    const currentPage = window.location.pathname.split('/').pop() || 'index.html';
    
    // Set desktop active links
    ...
    desktopLinks.forEach(link => {
        ...
        if (hrefFile === currentPage || 
            (currentPage === 'index.html' && hrefFile === 'index.html') ||
            (currentPage === 'about.html' && hrefFile === 'about.html') ||
            (currentPage === 'projects.html' && hrefFile === 'projects.html') ||
            (currentPage === 'services.html' && hrefFile === 'services.html') ||
            (currentPage === 'contact.html' && hrefFile === 'contact.html')) {
            link.classList.add('active');
        }
    });
    
    // Set mobile active links
...
// Scroll detection - ONLY for pages with anchor links
